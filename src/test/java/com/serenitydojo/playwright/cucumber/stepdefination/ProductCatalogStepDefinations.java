...
import com.serenitydojo.playwright.pageObject.*;
...
public class ProductCatalogStepDefinations {
    // calling pageObject Methods
    NavBar navBar;
    ...
    public void setupPageObjects() {
        navBar = new NavBar(PlaywrightCucumberFixtures.getPage()); // getPage() is used to retrive the page from parents
    ...
    // @DataTableType is used to fetch the values from the feature file other will get error
    @DataTableType
